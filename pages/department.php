        ...
        <form action="" method="post">
            <table class="table" border="0">
                <tr>
                    ...
                    <td>:</td>
                    <td><input type="text" class="form-control" name="pnumber"
                            value="<?php echo $objProject->pnumber; ?>"></td>
                </tr>
                <tr>
                    <td>Project Name</td>
                    <td>:</td>
                ...
                <tr>
                    ...
                    <td><input type="text" class="form-control" name="plocation"
                            value="<?php echo $objProject->plocation; ?>">
                    </td>
                </tr>
                <tr>
                    <td>Department</td>
                ...
                <tr>
                    ...
                    <td><input type="submit" class="btn btn-success" value="Save" name="btnSubmit">
                        <a href="dashboardadmin.php?p=projectlist" class="btn btn-warning">Cancel</a>
                    </td>
                </tr>
            </table>
        </form>
